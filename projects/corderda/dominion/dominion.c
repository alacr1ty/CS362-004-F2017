...
int cardEffectAdventurer(struct gameState *state, int currentPlayer, int drawntreasure, int cardDrawn, int temphand[MAX_HAND], int z){
...
int cardEffectVillage(struct gameState *state, int currentPlayer, int handPos){
  //+1 Card
  drawCard(currentPlayer, state);
...
int cardEffectTreasureMap(struct gameState *state, int currentPlayer, int handPos, int index, int i){
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      cardEffectAdventurer(state, currentPlayer, drawntreasure, cardDrawn, temphand, z);
    ...
    case village:
      return cardEffectVillage(state, currentPlayer, handPos);
    ...
    case treasure_map:
      return cardEffectTreasureMap(state, currentPlayer, handPos, index, i);
	}
